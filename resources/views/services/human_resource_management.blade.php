@extends('layouts.frontend', ['title' => 'Human Resource Management'])

@section('breadcrumb')
@includeIf('layouts.breadcrumb', ['title' => 'Human Resource Management', 'subtitle' => 'Human Resource Management'])
@endsection
