    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{route('admin.trainings')}}" class="waves-effect">
                        <i class="bx bx-chat"></i>
                        <span key="t-tasks">Trainings</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('admin.jobs')}}" class="waves-effect">
                        <i class="bx bx-chat"></i>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('admin.account')}}" key="t-user-grid">Account</a></li>
