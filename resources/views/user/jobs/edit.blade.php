                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('jobUpdate', Crypt::encrypt($job->id))}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div>
                                    <div class="form-group row mb-4">
                                        <label for="title" class="col-form-label col-lg-2">Title <span class="text-danger">*</span></label>
                                        <div class="col-lg-10">
                                            <input id="title" name="title" type="text" class="form-control" value="{{$job->title}}" placeholder="Enter Title..." required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label for="company" class="col-form-label col-lg-2">Company <span class="text-danger">*</span></label>
                                        <div class="col-lg-10">
                                            <input id="company" name="company" type="text" class="form-control" value="{{$job->company}}" placeholder="Enter Company..." required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label for="logo" class="col-form-label col-lg-2">Logo (JPEG, PNG, JPG) <span class="text-danger">*</span></label>
                                        <div class="col-lg-10">
                                            <input id="logo" name="logo" type="file" class="form-control" accept=".jpeg, .jpg, .png" placeholder="Upload Logo...">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <select id="workplace_type" name="workplace_type" type="text" class="form-control" required>
                                                ...
                                                <option value="{{$job->workplace_type}}">{{$job->workplace_type}}</option>
                                                @endif
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="location" name="location" type="text" class="form-control" value="{{$job->location}}" placeholder="Enter Location..." required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="salary" name="salary" type="text" class="form-control" value="{{$job->salary}}" placeholder="Enter Salary......">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label for="description" class="col-form-label col-lg-2">Description <span class="text-danger">*</span></label>
                                        <div class="col-lg-10">
                                            <textarea id="editor" class="form-control" value="{{$job->description}}" name="description">{{$job->description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label for="apply_link" class="col-form-label col-lg-2">Apply Link(If any)</label>
                                        <div class="col-lg-10">
                                            <input id="apply_link" name="apply_link" type="text" class="form-control" value="{{$job->apply_link}}" placeholder="Enter Apply Link...">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="applicant_collection_email_address" name="applicant_collection_email_address" type="email" value="{{$job->applicant_collection_email_address}}" class="form-control" placeholder="Enter Applicant Collection Email Address..." oninput="updateParagraph()" required>
                                            <p>You will receive applicants on {{config('app.name')}} and get notified at <span id="displayText">{{$job->applicant_collection_email_address}}</span></p>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <label>
                                                <input type="radio" name="rejection_emails" value="true" required @if($job->rejection_emails == true) checked @endif>
                                                Yes
                                            </label>

                                            <label>
                                                <input type="radio" name="rejection_emails" value="false" required @if($job->rejection_emails == false) checked @endif>
                                                No
                                            </label>
                                        </div>
                                    </div>
